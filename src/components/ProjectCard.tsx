...
export default function ProjectCard(props) {
  ...
  return (
    <div className={'flex flex-col ' + (index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse')}>
        ...
        <div className='flex flex-col flex-1 justify-center items-center custom-class'>
        ...
        <p className='text-xs sm:text-sm text-justify px-4 pb-4 sm:pb-6 sm:px-6'>{project.description}</p>
        </div>
    </div>
  )
}
