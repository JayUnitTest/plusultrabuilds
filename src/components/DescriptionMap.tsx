...
const contentDisplay = {
    'links': (obj) =><a className='text-[#388B83] dark:text-[#816797] cursor-pointer' target='_blank' href={obj.link}>{obj.content}</a>,
    ...
    <div className='flex flex-col gap-3 ml-5 mr-5 '>
        ...
        return (
          <div className='relative group overflow-hidden flex items-center gap-1.5 flex-wrap text-xs sm:text-sm' key={listIndex}>
            <div className='bg-[#A9C87C] dark:bg-[#816797] h-[2px] w-full  duration-300 group-hover:translate-x-full absolute right-full bottom-0'></div>
