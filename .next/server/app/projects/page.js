...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5774)), "E:\\plusultrabuilds\\src\\app\\projects\\page.tsx"],
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1062)), "E:\\plusultrabuilds\\src\\app\\layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2819))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["E:\\plusultrabuilds\\src\\app\\projects\\page.tsx"];
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "flex flex-col flex-1 justify-center items-center custom-class",
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx("p", {
                        className: "text-xs sm:text-sm text-justify px-4 pb-4 sm:pb-6 sm:px-6",
...
;// CONCATENATED MODULE: ./src/app/projects/page.tsx


function ProjectsPage() {
    const projects = [
        {
            name: "PlusUltraStrength",
        ...
        },
        {
            ...
            description: "Final year project at University. The aim of the project was to dip my toes in the waters of blockchain technology. This project aimed to create a notarisation app in which a user could notarise their document using the blockchain. The user would upload a file and will recieve a checksum correlating their file with a block on the blockchain. Check out the repo!",
            video: "OTBNOTARYDEMO.mp4"
        },
        {
            name: "Film-Fiends",
            link: "https://github.com/JayUnitTest/MovieAPISpring",
            description: "This project experiment with a full-stack application using Java Spring-Boot, MongoDB as the database and a front-end with react. The site is a movie review site in which users can submit a review on a movie. The review is then saved to a database. Check out the repo!",
            video: "FilmFiendsDemo.mp4"
        }
    ];
    return /*#__PURE__*/ jsx_runtime_.jsx("main", {
        className: "flex flex-col flex-1 mx-auto max-w-[900px] w-full bg-inherit",
        children: projects.map((project, projectIndex)=>{
            return /*#__PURE__*/ jsx_runtime_.jsx(ProjectCard, {
                project: project,
                index: projectIndex
            }, projectIndex);
        })
...
var __webpack_exports__ = __webpack_require__.X(0, [381,10,687], () => (__webpack_exec__(1717)));
